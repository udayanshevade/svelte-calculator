...
var app = (function () {
    ...
    */
    ...
    // (327:8) {#each rowConfig as { id, value, title, className, text }
    function create_each_block_1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(327:8) {#each rowConfig as { id, value, title, className, text }",
    		ctx
    	});
    ...
    // (325:4) {#each config as { className: rowClassName, config: rowConfig }}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 325, 6, 11239);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(325:4) {#each config as { className: rowClassName, config: rowConfig }}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 322, 2, 11092);
    			attr_dev(div1, "class", "calculator svelte-1hyyoi6");
    			add_location(div1, file$2, 321, 0, 11065);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
